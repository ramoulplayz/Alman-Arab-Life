...
const devs = ['410848175117565953'];
const db = require('quick.db');
const premium = ['410848175117565953']
...
client.on('ready', function(){
    ...
    setInterval(function (){
        ...
        i = i+j;
        client.user.setGame(setGame[i],`http://www.twitch.tv/System`);
    }, ms);
...
client.channels.get("575746621631889408").sendEmbed(embed)
});
                  ...
                  ctx.drawImage(ground, 0, 0, 400, 200);
                      ...
                      jimp.read(url, (err, ava) => {
                          ...
                          ava.getBuffer(jimp.MIME_PNG, (err, buf) => {
                              ...
                              ctx.fontSize = '20px';
                              ctx.fillStyle = "#f1f1f1";
      ctx.fillText(`Welcome To Hater Of Alger Telecom`, 260, 125);
  ...
  var invites = await message.guild.fetchInvites();
    ...
    invites.forEach(i => {
      ...
      if (i.uses === 30) {//يمديك تعدل رقم وصول العدد حق الانفايت الى اأقل أو أكثر
          message.member.addRole(message.member.guild.roles.find("name","شعب"))//هنآ أسم ألرتبه اللي تجيهه
.catch(RebeL =>{
